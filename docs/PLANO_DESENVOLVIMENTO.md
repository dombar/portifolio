...
| 7 | Membros via API externa mockada | `MockMemberController`, `MemberExternalClient` | Fase 4 |
...
- [x] `MockMemberController` (API externa simulada)
...
- [x] Spring Security (Basic Auth, usuário in-memory)
- [x] SpringDoc OpenAPI / Swagger UI

### Fase 8 — Qualidade
- [x] Testes unitários (33 testes)
- [x] JaCoCo: cobertura ≥70% em `service` e `service/rule`
...
- [x] Testes unitários (≥70% regras de negócio)
- [x] Camadas controller/service/repository
- [x] Paginação e filtros
- [x] Spring Security básico
